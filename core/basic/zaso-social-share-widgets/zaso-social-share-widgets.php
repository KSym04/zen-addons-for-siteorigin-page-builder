...
class Zen_Addons_SiteOrigin_Social_Share_Widget extends SiteOrigin_Widget {
	...
	public static function networks() {
		return array(
			'facebook' => array(
				'label' => __( 'Facebook', 'zen-addons-for-siteorigin-page-builder' ),
				'color' => '#1877f2',
			...
			'x'        => array(
				'label' => __( 'X', 'zen-addons-for-siteorigin-page-builder' ),
				'color' => '#000000',
			...
			'linkedin' => array(
				'label' => __( 'LinkedIn', 'zen-addons-for-siteorigin-page-builder' ),
				'color' => '#0a66c2',
			...
			'pinterest' => array(
				'label' => __( 'Pinterest', 'zen-addons-for-siteorigin-page-builder' ),
				'color' => '#e60023',
			...
			'reddit'   => array(
				'label' => __( 'Reddit', 'zen-addons-for-siteorigin-page-builder' ),
				'color' => '#e03d00',
			...
			'whatsapp' => array(
				'label' => __( 'WhatsApp', 'zen-addons-for-siteorigin-page-builder' ),
				'color' => '#1a8a4d',
			...
			'telegram' => array(
				'label' => __( 'Telegram', 'zen-addons-for-siteorigin-page-builder' ),
				'color' => '#1c8cc2',
			...
			'email'    => array(
				'label' => __( 'Email', 'zen-addons-for-siteorigin-page-builder' ),
				'color' => '#475569',
			...
			'copy'     => array(
				'label' => __( 'Copy Link', 'zen-addons-for-siteorigin-page-builder' ),
				'color' => '#334155',
				'url'   => '',
	...
	function __construct() {
		...
		$zaso_social_share_field_array = array(
			'networks'     => array(
				'type'   => 'section',
				'label'  => __( 'Networks', 'zen-addons-for-siteorigin-page-builder' ),
				'hide'   => false,
				'fields' => $network_fields,
			),
			'share_source' => array(
				'type'    => 'select',
				'label'   => __( 'Share Target', 'zen-addons-for-siteorigin-page-builder' ),
				'default' => 'current',
				'options' => array(
					'current' => __( 'Current Page', 'zen-addons-for-siteorigin-page-builder' ),
					'custom'  => __( 'Custom URL', 'zen-addons-for-siteorigin-page-builder' ),
				),
			),
			'custom_url'   => array(
				'type'        => 'link',
				'label'       => __( 'Custom URL', 'zen-addons-for-siteorigin-page-builder' ),
				'description' => __( 'Used only when Share Target is set to Custom URL.', 'zen-addons-for-siteorigin-page-builder' ),
			),
			'custom_title' => array(
				'type'        => 'text',
				'label'       => __( 'Custom Title', 'zen-addons-for-siteorigin-page-builder' ),
				'description' => __( 'Optional. Overrides the auto-detected page title in the share text.', 'zen-addons-for-siteorigin-page-builder' ),
			),
			'show_labels'  => array(
				'type'    => 'checkbox',
				'label'   => __( 'Show Network Labels', 'zen-addons-for-siteorigin-page-builder' ),
				'default' => false,
			),
			'design'       => array(
				'type'   => 'section',
				...
				'fields' => array(
					'shape'          => array(
						'type'    => 'select',
						'label'   => __( 'Button Shape', 'zen-addons-for-siteorigin-page-builder' ),
						'default' => 'rounded',
						'options' => array(
							'square'  => __( 'Square', 'zen-addons-for-siteorigin-page-builder' ),
							'rounded' => __( 'Rounded', 'zen-addons-for-siteorigin-page-builder' ),
							'circle'  => __( 'Circle', 'zen-addons-for-siteorigin-page-builder' ),
						),
					),
					'color_mode'     => array(
						'type'    => 'select',
						'label'   => __( 'Color Mode', 'zen-addons-for-siteorigin-page-builder' ),
						'default' => 'brand',
						'options' => array(
							'brand' => __( 'Brand Colors', 'zen-addons-for-siteorigin-page-builder' ),
							'mono'  => __( 'Single Color', 'zen-addons-for-siteorigin-page-builder' ),
						),
					),
					'mono_bg_color'  => array(
						'type'        => 'color',
						'label'       => __( 'Single Color: Button', 'zen-addons-for-siteorigin-page-builder' ),
						'default'     => '#01949a',
						'description' => __( 'Used only when Color Mode is Single Color.', 'zen-addons-for-siteorigin-page-builder' ),
					),
					'mono_icon_color' => array(
						'type'    => 'color',
						'label'   => __( 'Single Color: Icon', 'zen-addons-for-siteorigin-page-builder' ),
						'default' => '#ffffff',
					),
					'alignment'      => array(
						'type'    => 'select',
						...
						'default' => 'flex-start',
						'options' => array(
							'flex-start' => __( 'Left', 'zen-addons-for-siteorigin-page-builder' ),
							'center'     => __( 'Center', 'zen-addons-for-siteorigin-page-builder' ),
							'flex-end'   => __( 'Right', 'zen-addons-for-siteorigin-page-builder' ),
						),
					),
					'icon_size'      => array(
						'type'    => 'measurement',
					...
					'gap'            => array(
						'type'    => 'measurement',
						'label'   => __( 'Gap Between Buttons', 'zen-addons-for-siteorigin-page-builder' ),
						'default' => '8px',
					),
				),
			),
		...
		parent::__construct(
			...
			__( 'Zen Addons - Social Share Bar', 'zen-addons-for-siteorigin-page-builder' ),
			array(
				'description'   => __( 'A row of share buttons plus a copy-link button. Server-built share URLs, no third-party scripts.', 'zen-addons-for-siteorigin-page-builder' ),
