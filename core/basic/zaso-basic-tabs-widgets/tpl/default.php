...
<div <?php echo zaso_format_field_extra_id( $instance['extra_id'] ); ?> class="zaso-basic-tabs <?php echo esc_attr( $instance['extra_class'] ); ?>">
    <div class="zaso-basic-tabs__list" role="tablist" aria-label="<?php echo esc_attr( sanitize_title( $instance['tab_main_title'] ) ); ?>">
      <?php
        // counter
        $tt_count = 0;
      ...
      ?>
            <button class="zaso-basic-tabs__title"
                  ...
                  aria-controls="<?php echo esc_attr( $tt_title_formatted ); ?>-tab"
                  id="<?php echo esc_attr( $tt_title_formatted ); ?>"
    ...
    ?>
        <div class="zaso-basic-tabs__content" tabindex="0" role="tabpanel"
             id="<?php echo esc_attr( $tt_title_formatted ); ?>-tab"
             aria-labelledby="<?php echo esc_attr( $tt_title_formatted ); ?>" <?php echo ( $tc_count == 0 ) ? "" : "hidden"; ?>>
