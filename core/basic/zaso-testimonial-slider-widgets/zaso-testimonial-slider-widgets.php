	...
	function __construct() {
		...
		$zaso_testimonial_slider_field_array = array(
			...
			'design_style'      => array(
				...
				'default_preset' => '',
				/**
				 * Curated design presets ("skins") for this widget, drawn from the
				 * canonical Zen Addons premium palette. The free core ships four
				 * (one per aesthetic family); Zen Addons Pro appends the full
				 * 12-scheme library via the shared `zaso_design_presets` filter
				 * (gated on a valid license). Role mapping: surface -> card bg,
				 * text -> quote + author name, text_muted -> author title,
				 * accent -> stars + arrows + active dot, border -> inactive dot.
				 * Every text/background pair meets WCAG AA. Selecting a preset
				 * fills the Design fields below; users can still tweak.
				 */
					...
					'dark_midnight' => array(
						...
						'values' => array(
							'design' => array(
								...
								'quote_color'        => '#e2e8f0',
								'quote_italic'       => 'no',
								'author_name_color'  => '#e2e8f0',
								'author_title_color' => '#94a3b8',
								'star_color'         => '#e2e8f0',
					...
					'bold_sunset'   => array(
						...
						'values' => array(
							'design' => array(
								...
								'quote_color'        => '#7c2d12',
								'quote_italic'       => 'yes',
								'author_name_color'  => '#7c2d12',
								'author_title_color' => '#9a3412',
								'star_color'         => '#c2410c',
								'card_background'    => '#fff7ed',
								'card_padding'       => array( 'top' => '34px', 'right' => '34px', 'bottom' => '34px', 'left' => '34px' ),
								'card_border_radius' => '16px',
								'arrow_color'        => '#c2410c',
								'dot_color'          => '#fed7aa',
								'dot_active_color'   => '#c2410c',
							),
						),
					),
				), 'testimonial-slider' ),
