...
<div <?php echo zaso_format_field_extra_id( $instance['extra_id'] ); ?> class="zaso-before-after <?php echo esc_attr( $instance['extra_class'] ); ?>">
	...
	<?php else : ?>
		<div class="zaso-before-after__container zaso-before-after__container--<?php echo esc_attr( $orientation ); ?>" data-orientation="<?php echo esc_attr( $orientation ); ?>" style="--zaso-ba-pos:<?php echo esc_attr( $position ); ?>%;">
			...
			<img class="zaso-before-after__img zaso-before-after__before-img" src="<?php echo esc_url( $before['src'] ); ?>" alt="<?php echo esc_attr( $before['alt'] ); ?>" loading="lazy" draggable="false" aria-hidden="true" />
			...
			<button type="button" class="zaso-before-after__handle" role="slider" tabindex="0" aria-label="<?php echo esc_attr( $slider_label ); ?>" aria-orientation="<?php echo esc_attr( $orientation ); ?>" aria-valuemin="0" aria-valuemax="100" aria-valuenow="<?php echo esc_attr( $position ); ?>">
