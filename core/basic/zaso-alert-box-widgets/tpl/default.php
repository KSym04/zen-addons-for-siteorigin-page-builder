...
$zaso_alert_types = array(
	'info'    => array(
		'label' => __( 'Information:', 'zen-addons-for-siteorigin-page-builder' ),
	...
	'success' => array(
		'label' => __( 'Success:', 'zen-addons-for-siteorigin-page-builder' ),
	...
	'warning' => array(
		'label' => __( 'Warning:', 'zen-addons-for-siteorigin-page-builder' ),
	...
	'error'   => array(
		'label' => __( 'Error:', 'zen-addons-for-siteorigin-page-builder' ),
...
<div <?php echo zaso_format_field_extra_id( $instance['extra_id'] ); ?> class="<?php echo esc_attr( $zaso_wrapper_class ); ?> <?php echo esc_attr( $instance['extra_class'] ); ?>">
  <div class="<?php echo esc_attr( $zaso_box_class ); ?>">
    <?php if( $instance['alert_closebtn'] == 'show' ) : ?>
      <button type="button" class="zaso-alert-box__closebtn" data-dismiss="alert" aria-label="<?php esc_attr_e( 'Close', 'zen-addons-for-siteorigin-page-builder' ); ?>">
        <span aria-hidden="true"><?php esc_html_e( '&times;', 'zen-addons-for-siteorigin-page-builder' ); ?></span>
      </button>
    <?php endif; ?>
